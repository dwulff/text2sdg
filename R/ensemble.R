...
#'
#' By default, \code{detect_sdg} implements an ensemble model that has been trained on an equal amount of expert-labeled and synthetic data, providing a reasonable balance between sensitivity and specificity. For details, see article by Wulff et al. (2023).
#'
...
>>>>>>> e471ab9cb7f0985a6aa560a117687923b8eb3d2f
  ensemble_sel = ensembles[[synthetic]]
  if(verbose) cat("\nRunning systems",sep = '')
  # run detect sdg
  hits = detect_sdg_systems(text = corpus,
                    sdgs = sdgs,
